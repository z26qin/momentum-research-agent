...
SIGNALS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("coordination_scaling", "live_replan", "src", r"class AgentBus\b|async def replan\b|def staged_return\b"),
    ...
    ("training_loop", "trajectory_log", "src", r"trajectory_log|ExecutionTrace|replay_record"),
    ("training_loop", "prompt_evolution", "src", r"evolve_prompt|profile_patch|sft_mixture"),
